...
CsPTx_seqs <- readDNAStringSet("data/getfasta_results/blast_exons/merged_CDS_CsPTx.2022-05-29.fasta")
CsPTx_ref_seqs <- readDNAStringSet("merged_ref_CsPTx.fasta")
outgroup_seqs <- readDNAStringSet("merged_HlPTx.fasta")
CsPTx_seqs <- c(CsPTx_seqs, CsPTx_ref_seqs, outgroup_seqs)
CsPTx_alignment <- msa(CsPTx_seqs, method = "ClustalW")

CsPTx_Str <- as(CsPTx_alignment, "DNAStringSet")
writeXStringSet(CsPTx_Str, file="data/getfasta_results/blast_exons/merged_CDS_CsPTx_and_outgroup.fasta.ClustalW")

CsPTx_phyDat <- read.phyDat("data/getfasta_results/blast_exons/merged_CDS_CsPTx_and_outgroup.fasta.ClustalW", format = "fasta", type = "DNA")
...
plotBS(tree = midpoint(fitJC$tree), BStrees = bs, p = 50, type = "p")
?plotBS
